...
$con->q_exe("select fileid from print_task where pid = :pid limit 3;",array("pid"=>$printid));
$files=$con->rows;
...
$con->q_exe("select filename, predefined from pdf_files where fileid = :fileid limit 1;",array("fileid"=>$fileid['fileid']));
